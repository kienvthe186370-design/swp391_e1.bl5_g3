...
<%
    ...
    request.setAttribute("pageTitle", "create".equals(mode) ? "Thêm Nhân viên" : "Chỉnh sửa Nhân viên");
...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">
            ...
            <%= "create".equals(mode) ? "Thêm Nhân viên mới" : "Chỉnh sửa Nhân viên" %>
          </h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">
              <%= "create".equals(mode) ? "Thêm mới" : "Chỉnh sửa" %>
            </li>
          </ol>
        </div>
      </div>
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <!-- Sử dụng form CHUNG -->
      <jsp:include page="../shared/form-employee.jsp"/>
    </div>
  </section>
</div>
