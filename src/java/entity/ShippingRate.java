...
public class ShippingRate {
    ...
    public int getCarrierID() { return carrierIDInt; }
    public void setCarrierID(int carrierID) { this.carrierIDInt = carrierID; }
    ...
    public String getCarrierLogo() { return carrierLogo; }
    public void setCarrierLogo(String carrierLogo) { this.carrierLogo = carrierLogo; }

    public String getCarrierShortName() { return carrierShortName; }
    public void setCarrierShortName(String carrierShortName) { this.carrierShortName = carrierShortName; }
